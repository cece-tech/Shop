	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Admin Dashboard</span>
              ...
              <i class="align-middle" data-feather="star"></i> <span class="align-middle">Manage Review Product</span>
            </a>
					</li>
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="{{ Auth::user()->name }}" /> <span class="text-dark"></span>
              </a>
							<div class="dropdown-menu dropdown-menu-end">
								...
								<form action="{{route('logout')}}" method="POST">
									@csrf
									<input type="submit" value="logout" class="ms-3 btn-outline-warning">
								</form>
							</div>
						</li>
					</ul>
